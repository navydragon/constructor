<template>
  <b-navbar toggleable="lg" :variant="getLayoutNavbarBg()" class="layout-navbar align-items-lg-center container-p-x">
    ...
    <!-- Brand -->
    <b-navbar-brand to="/">Конструктор ДПП</b-navbar-brand>
    ...
    <b-collapse is-nav id="app-layout-navbar">
      <b-navbar-nav class="align-items-lg-center">
        ...
        <b-nav-item-dropdown no-caret v-if="$auth.check()" class="demo-navbar-messages mr-lg-3">
          <template slot="button-content">
        ...
        <b-nav-item-dropdown v-if="$auth.check()" class="demo-navbar-user">
          <template slot="button-content">
          ...
          <b-dd-divider />
          <b-dd-item><a href="#" @click.prevent="$auth.logout()"><i class="ion ion-ios-log-out text-danger"></i> &nbsp; Выход</a></b-dd-item>
        </b-nav-item-dropdown>
      </b-navbar-nav>
    </b-collapse>
