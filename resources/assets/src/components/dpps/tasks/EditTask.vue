            ...
            <b-tab title="Описание" active>
              ...
              <b-modal id="modal-1"  ok-title="Сохранить" size="xl" no-close-on-esc no-close-on-backdrop @ok="update_specification" cancel-title="Закрыть" title="Редактирование описания">
                <div v-if="new_task.task_type_id==1">
                  <b-form-group size="lg" description="" label="Описание ситуации и постановка задачи">
                    <b-form-textarea v-model="new_task.specification.description"></b-form-textarea>
                  </b-form-group>
                  <b-form-group size="lg" description="" label="Условия выполнения задания">
                  </b-form-group>
                  <b-form-group size="lg" description="" label="Место выполнения">
                      <b-form-textarea v-model="new_task.specification.place"></b-form-textarea>
                  </b-form-group>
                  <b-form-group size="lg" description="" label="Источники информации для выполнения">
                      <b-form-textarea v-model="new_task.specification.source"></b-form-textarea>
                  </b-form-group>
                  <b-form-group size="lg" description="" label="Максимальное время выполнения (минут)">
              ...
              <div v-if="new_task.task_type_id==1">
                ...
                <h5>Максимальное время выполнения</h5>
                <h5></h5>
              </div>
