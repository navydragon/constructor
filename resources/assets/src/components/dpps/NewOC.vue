<template>
    <div>
        ...
        <div>
            ...
            <span class="btn btn-success" @click="check_stage()">Согласовать результаты и перейти к следующему этапу</span>
        </div>
            <b-alert v-if="errors.length>0" show dismissible variant="danger"><strong>Обнаружены ошибки:</strong>
            <ul>
        ...
        <edit-competence2 v-if="!isBusy&&edit_elem.id!='0'&&edit_type=='competence'" @update_competence="update_competence" :edit_elem="edit_elem.id" :key="'c'+edit_elem.id"></edit-competence2>
    </div>
</template>
...
<script>
    ...
    export default {
        ...
        components: {
            OrgChart, NewSkill2, NewAbility2, NewKnowledge2, NewCompetence2, AddParent2,EditSkill2,EditAbility2,EditKnowledge2,EditCompetence2
        },
        methods: {
            ...
            oc: function(domEl, x) {
              //  OrgChart.templates.ula.exportMenuButton = '<div style="position:absolute;right:{p}px;top:{p}px; width:40px;height:50px;cursor:pointer" control-export-menu=""  ><i class="fas fa-file-export"></i></div>';
                OrgChart.templates.comp_template = Object.assign({}, OrgChart.templates.ula);
                    ...
                    OrgChart.templates.comp_template.node = '<rect x="0" y="0" fill= "#040347" width="400" height="160"  rx="5" ry="5"/>'
                    ...
                    OrgChart.templates.comp_template.field_1 = '<foreignObject x="10" y="5" width="375" height="20">'
                    ...
                    OrgChart.templates.comp_template.field_0 = '<foreignObject x="10" y="35" width="375" height="125">'
                    ...
                    OrgChart.templates.skil_template.node = '<rect x="0" y="0" fill= "#040347" width="400" height="160"  rx="5" ry="5"/>'
                    OrgChart.templates.skil_template.field_1 = '<foreignObject x="10" y="5" width="390" height="50">'
                    + '<span class="print_type text-white" style="margin:0px; line-height: 100%; font-weight:bolder;">{val}</span></foreignObject>'                         
                    OrgChart.templates.skil_template.field_0 = '<foreignObject x="10" y="35" width="390" height="125">'
                    + '<p class="text-white" style="margin:0px; line-height: 100%;"> {val}</p></foreignObject>'
                    ...
                    OrgChart.templates.abil_template.node = '<rect x="0" y="0" fill= "#040347" width="400" height="160"  rx="5" ry="5"/>'
                    OrgChart.templates.abil_template.field_1 = '<foreignObject x="10" y="5" width="390" height="50">'
                    + '<span class="print_type text-white" style="margin:0px; line-height: 100%; font-weight:bolder;">{val}</span></foreignObject>'                         
                    OrgChart.templates.abil_template.field_0 = '<foreignObject x="10" y="35" width="390" height="125">'
                    + '<p class="text-white" style="margin:0px; line-height: 100%;"> {val}</p></foreignObject>'
                    ...
                    + '<span class="print_type text-white" style="margin:0px; line-height: 100%; font-weight:bolder;">{val}</span></foreignObject>'                         
                    OrgChart.templates.know_template.field_0 = '<foreignObject x="10" y="35" width="390" height="70">'
                    + '<p class="text-white" style="margin:0px; line-height: 100%;"> {val}</p></foreignObject>'
                    ...
                    OrgChart.templates.through_template.field_0 = '<foreignObject x="100" y="40" width="390" height="70">'
               ...
               this.chart = new OrgChart(domEl, {
                ...
                "competence": {
                    ...
                    edit_competence: { text: "Редактировать", icon: '<i class="fas fa-edit"></i>', onClick: function(node){ self.edit_competence(node) } },
            ...
            add_skill(data)
            {
                ...
                .then( function(response) {
                  ...
                  self.chart.addNode({ id: response.data.new_id, pid: response.data.new_parent, name: response.data.name, valid: response.data.valid, type: new_type,tags:["skill"] }) 
            ...
            add_ability(data)
            {
                ...
                .then( function (response) {
                    ...
                    self.chart.addNode({ id: response.data.new_id, pid: response.data.new_parent, name: response.data.name, valid: response.data.valid, type: new_type,tags:["ability"] })
                    self.chart.center(response.data.new_id);
                })
                .finally( function() {
                   // self.oc(self.$refs.tree, self.nodes)
            ...
            add_knowledge(data)
            {
                ...
                .then(function(response) {
                    ...
                    self.chart.addNode({ id: response.data.new_id, pid: response.data.new_parent, name: response.data.name, type: new_type, valid: response.data.valid, tags:["knowledge"] })
                    self.chart.center(response.data.new_id);
                    })
                .finally( function() {
                    //self.oc(self.$refs.tree, self.nodes)
            ...
            make_competence()
            {
               var elems = this.nodes.filter(node => ((node.pid == null) || (node.pid == 'c') || (node.pid == 's')))
            ...
            add_competence(data)
            {
                ...
                .then(function(response){
                    ...
                    self.chart.addNode({ id: response.data.new_id, pid: null, name: response.data.name, valid: true, type: "Компетенция",tags:["competence"] })
